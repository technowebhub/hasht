...
### Configurations
- Set the hashtag to be pulled in [config.php](https://github.com/technowebhub/hasht/tree/master/config.php).
- Backups are located [here](https://github.com/technowebhub/hasht/tree/master/db).

	- Place database credentials into [config.php](https://github.com/technowebhub/hasht/tree/master/config.php).
...
5. View the details tab. Copy and paste the correlating keys and secrets into [config.php](https://github.com/technowebhub/hasht/tree/master/config.php).
...
8. Copy and paste the value for the access token into the access token for
   instagram field in [config.php](https://github.com/technowebhub/hasht/tree/master/config.php).
